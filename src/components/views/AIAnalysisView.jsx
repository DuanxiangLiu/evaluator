...
import AIDiagnosisButton, { REPORT_MODES } from '../common/AIDiagnosisButton';
...
const AIAnalysisView = ({
  ...
  const [currentMode, setCurrentMode] = useState('detailed');
            ...
            helpContent={
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-emerald-300 text-xs">报告模式</h4>
                  <ul className="text-gray-300 text-xs space-y-1">
                    <li>• <strong>快速摘要</strong>：核心结论和关键指标</li>
                    <li>• <strong>详细分析</strong>：全面的统计与案例分析</li>
                    <li>• <strong>执行报告</strong>：面向管理层的决策支持</li>
                    <li>• <strong>技术深潜</strong>：深入的统计验证分析</li>
                  </ul>
                </div>
            ...
            <div className="flex flex-col items-center justify-center h-full text-gray-400 space-y-5">
              ...
              <div className="text-center max-w-md">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  选择报告模式，点击「生成报告」按钮，AI 将基于当前统计数据生成专业的算法评估报告
                </p>
